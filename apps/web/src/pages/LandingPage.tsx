      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <header className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-slate-800 bg-slate-950/75 px-5 py-4 backdrop-blur">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {isMockApiMode ? <Button className="bg-sky-400 text-slate-950" onClick={enterDemo}>Try public demo</Button> : <Link to="/login"><Button className="bg-sky-400 text-slate-950">Start Free</Button></Link>}
          </div>
        </header>
        ...
        <section className="grid gap-8 py-16 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">{isMockApiMode ? <Button className="bg-sky-400 text-slate-950" onClick={enterDemo}>Try public demo</Button> : <Link to="/login"><Button className="bg-sky-400 text-slate-950">Start Free</Button></Link>}<Link to="/pricing"><Button className="border border-slate-700 bg-slate-900 text-white">Explore School Plan / Request Demo</Button></Link></div>
